...
static char *fonts[]          = { "Roboto Slab:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char normbgcolor[]           = "#222222";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#fabd2f";
static char selbgcolor[]            = "#006666";
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,       NULL,       "sxiv",     	    0,            0,           0,         1,        -1 },
	{ NULL,       NULL,       "Lenovo A6020a40",0,            1,           0,         1,        -1 },
	{ NULL,       NULL,       "svkbd",          0,            1,           0,         0,        -1 },
	{ NULL,       NULL,       "Event Tester",   0,            0,           0,         1,        -1 },
	{ NULL,       NULL,       "cava",           0,            1,           1,         1,        -1 },
...
ResourcePref resources[] = {
		...
		{ "mfact",		FLOAT,	&mfact }, { "gappih",		INTEGER, &gappih },
...
//	{ MODKEY,			XK_F8,		spawn,		SHCMD("mw -Y") },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim -u  pic-full-$(date '+%d-%m-%y-%H_%M_%S').png") },
	...
	{ 0, XF86XK_AudioPrev,		spawn,		SHCMD("mocp --prev") },
	{ 0, XF86XK_AudioNext,		spawn,		SHCMD("mocp --next") },
/*	{ 0, XF86XK_AudioPause,		spawn,		SHCMD("mocp --pause") },*/
	...
	{ 0, XF86XK_Mail,		spawn,		SHCMD(TERMINAL " -e firefox https://gmail.com ; pkill -RTMIN+12 dwmblocks") },
